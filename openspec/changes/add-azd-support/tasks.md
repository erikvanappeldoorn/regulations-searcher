...
- [x] 5.3 Assign the `Search Index Data Contributor` role on the Search service to the `principalId` parameter
...
- [x] 6.2 Verify the hook is idempotent (safe to run on every `azd up`, not just the first)
